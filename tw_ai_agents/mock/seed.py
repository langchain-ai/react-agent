...
from tw_ai_agents.mock.sample_data import SAMPLE_ORDERS, SAMPLE_CUSTOMERS

os.makedirs(get_mock_db_folder(), exist_ok=True)

conn = sqlite3.connect(get_mock_db_folder() / "erp_info.db")
cursor = conn.cursor()
...
print(
    "Database seeded successfully with order data and customer ERP information."
)
